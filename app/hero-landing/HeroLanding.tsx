...
export const HeroImageBackground = () => {
  ...
  return (
    <>
      ...
      <div style={{ padding: mobile ? "0 12px" : "0 8%" }}>
        <div style={{
          display: 'grid',
      ...
      <Box bg={primaryColor} mx={"8%"} style={{ borderRadius: "21px" }}>
        <Flex gap={'xl'} justify="center" align={'center'} p={tablet ? rem(40) : rem(20)} direction={mobile?'column-reverse':'row'}>
          <Flex direction={"column"} justify={"center"} c={white} >
            <Text maw={'670px'} style={{ textAlign:'justify', fontSize: mobile || tablet ? rem(16) : rem(24), fontWeight: "600", marginBottom: "50px" }}>Teruntuk Bapak dan Ibu Dewan diatas, Jangan ulangi lagi rekam jejak burukmu dalam menghambat upaya pengendalian konsumsi rokok dan membela kepentingan industri rokok ya!</Text>
